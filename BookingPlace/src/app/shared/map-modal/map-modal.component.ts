...
export class MapModalComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    private modalcCtrl: ModalController,
  ...
  private getGoogleMaps(): Promise<any> {
    ...
    const googleModel = win.google;
    if(googleModel && googleModel.maps) {
      return Promise.resolve(googleModel.maps);
    }
    return new Promise((resolve, reject) => {
      // così interagisco con il DOM e SDK di maps lo inserisco qui
